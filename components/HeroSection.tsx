...
// ============================================
// DATA (unchanged, but we use it statically)
// ============================================
...
const EDUCATION_RESOURCES = [
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M6 10v6c0 1.5 2.7 3 6 3s6-1.5 6-3v-6" />
      </svg>
    ),
  },
  {
...
// ============================================
// COMPONENTS (all lightweight, pure Tailwind)
// ============================================
...
// Hero section – clean, no heavy effects
    ...
    <section className="relative w-full min-h-screen flex items-center bg-[#0f1117] overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-24 sm:py-32">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          {/* Partner Logos – auto-rotate with hover */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 order-2 lg:order-1">
            ...
            <div>
              <h1 className="font-extrabold leading-[0.9] tracking-tight">
                ...
                <span className="block text-[clamp(48px,8vw,96px)] text-red-500">
                  FX
                </span>
              </h1>
          ...
          <div className="grid grid-cols-2 gap-3 order-1 lg:order-2">
            {CARDS.map((card, index) => (
              <div
                key={card.title}
                className="group p-4 sm:p-5 bg-[#1a1d25] border border-[#2a2d35] hover:border-red-500/30 rounded-[5px] transition-all duration-300 hover:bg-[#1e212a] hover:-translate-y-1 hover:shadow-2xl hover:shadow-red-500/5"
              >
                <div className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-[5px] bg-red-500/10 text-red-400 mb-3 group-hover:bg-red-500/20 group-hover:scale-110 transition-all duration-300">
                  {card.icon}
                </div>
...
// Platform Section – only tab switching, no extra animations
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-1 lg:order-2" key={active.key}>
            <h3 className="font-bold text-2xl sm:text-3xl mb-4 text-white">{active.title}</h3>
            <p className="text-slate-400 mb-6 leading-relaxed">{active.desc}</p>
...
// Education Section – simple cards, no fancy animations
    ...
    <section id="education" className="py-20 sm:py-28 px-5 sm:px-6 lg:px-8 bg-[#13161c] relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          {EDUCATION_RESOURCES.map((item) => (
            <div
              key={item.title}
              className="group bg-[#1a1d25] border border-[#2a2d35] hover:border-red-500/30 rounded-[5px] p-5 sm:p-6 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-red-500/5"
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-[#2a2d35] group-hover:border-red-500/20 transition-colors duration-300">
...
export default function HomePage() {
  ...
  return (
    <div className="bg-[#0f1117] text-white min-h-screen">
      ...
      {/* Image Showcase – simple */}
      <section className="py-20 sm:py-28 bg-[#13161c]">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="relative rounded-[5px] overflow-hidden border border-[#2a2d35] shadow-2xl shadow-black/50 group">
              ...
              <div className="absolute bottom-4 left-4 bg-black/80 backdrop-blur-sm text-white text-xs px-3 py-1.5 rounded-[5px]">
      ...
      {/* Markets Section */}
      <section id="markets" className="py-16 sm:py-20 px-5 sm:px-6 lg:px-8 bg-[#13161c]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {SERVICES.map((service) => (
              <div
                key={service.title}
                className="group bg-[#1a1d25] border border-[#2a2d35] hover:border-red-500/30 rounded-[5px] transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl overflow-hidden"
              >
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 text-center">
            <div>
              ...
              <p className="text-xs uppercase tracking-wider text-slate-500 mt-1">Instruments</p>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-bold text-white">0.0</p>
              <p className="text-xs uppercase tracking-wider text-slate-500 mt-1">Min Spread</p>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-bold text-white">&lt;40ms</p>
              <p className="text-xs uppercase tracking-wider text-slate-500 mt-1">Execution Speed</p>
            </div>
            <div>
      ...
      <section className="py-20 sm:py-28 px-5 sm:px-6 lg:px-8 bg-[#0f1117]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {TESTIMONIALS.map((testimonial) => (
              <div
                ...
                className="group relative bg-gradient-to-br from-[#1a1d25] to-[#13161c] border border-[#2a2d35] hover:border-red-500/40 rounded-[5px] transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-red-500/10 overflow-hidden"
              >
                ...
                <div className="relative p-7">
                  ...
                  <div className="flex items-center gap-4 pt-5 border-t border-[#2a2d35] group-hover:border-red-500/20 transition-colors duration-300">
                    <div className="relative">
                      <div className="w-12 h-12 rounded-full overflow-hidden bg-[#1a1d25] border-2 border-[#2a2d35] group-hover:border-red-500/50 transition-colors duration-300 flex-shrink-0">
                        <Image src={testimonial.avatar} alt={testimonial.name} width={48} height={48} className="object-cover" sizes="48px" loading="lazy" />
                      </div>
                    </div>
                    ...
                    <div className="flex-shrink-0">
                      <div className="w-8 h-8 rounded-[5px] bg-red-500/10 flex items-center justify-center group-hover:bg-red-500/20 transition-colors duration-300">
